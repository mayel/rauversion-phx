defmodule RauversionExtension.UI.PlaylistLive.PlaylistShowItemsComponent do
                      ...
                      <div class="flex items-center space-x-4">
                        <div class="flex-1 min-w-0">
                          ...
                          <p class="text-sm text-gray-500 truncate">
                            <%= live_redirect track_playlists.track |> username(),
                              to: routes().profile_index_path(@socket, :index, track_playlists.track |> username())
